...
/**
 * Production implementation of [WhiteboardRepository].
 * Injected via [WhiteboardRepository] interface — never inject this class directly.
 */
@Singleton
class WhiteboardRepositoryImpl @Inject constructor(
    ...
    override fun fetchWhiteboard(): Whiteboard {
